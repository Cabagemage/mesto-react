...
function GridTemplate(props) {
  return (
    <div className="grid-card" key={props.key}> 
                
    <img className="grid-card__photo" style={{ backgroundImage: `url(${props.link})`}} alt="" onClick={props.onCardClick} />
    <button className="grid-card__remove"></button>
    <div className="grid-card__textbox">
        <h2 className="grid-card__title">{props.name}</h2>
